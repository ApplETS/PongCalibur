// HTML5_Template Mickey MacDonald 2013
(function () {
    //"use strict";
    ...
    function prepareGame() {
        ...
        // Game Title //
        /*title = new createjs.Text("RegexCalibur Pong !", "25px sans-serif", "#cccccc");
        ...
        //createjs.Shape();
        //createjs.DOMElement('').onClick(function () { });
        ...
        switch (e) {
            ...
            case 'scoreboard':
                for (sc in scoreBoard) {
                    stage.addChild(new createjs.Text(sc.name + " - Score : " + sc.score, "25px sans-serif", "#cccccc"));
                }
                break;
        }
